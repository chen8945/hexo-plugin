...
hexo.extend.filter.register('after_generate', function (locals) {
  ...
  // 集体声明配置项
    const data = {
      ...
      runtime_js: config.runtime_js ? urlFor(config.runtime_js) : "https://cdn.jsdelivr.net/gh/chen8945/hexo-plugin@master/hexo-butterfly-footer-beautify/lib/runtime.js",
      runtime_css: config.runtime_css ? urlFor(config.runtime_css) : "https://cdn.jsdelivr.net/gh/chen8945/hexo-plugin@master/hexo-butterfly-footer-beautify/lib/runtime.css",
